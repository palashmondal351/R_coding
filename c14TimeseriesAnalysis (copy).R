...
# PERFORMING CALCULATION ON TIME SERIES
data3
diff(data3)
diff(data3) / data3
...
# PLOTTING THE AUTO-CORRELATON FUNCTION
acf(PG$PG.Adjusted)
...
# FINDING LAG CORRELATIONS BETWEEN TWO TIME SERIES
require(graphics)
